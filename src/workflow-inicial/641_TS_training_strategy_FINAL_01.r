...
PARAM <- list()
PARAM$experimento <- "TS6410_FINAL_01"

PARAM$exp_input <- "FE6310_FINAL_01"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 201912,
  201911, 201910, 201909, 201908, 201907, 201906
)

PARAM$train$training <- c(
  202101,
  202012, 202011, 202010, 202009, 202008, 201912, 201911,
...
PARAM$train$semilla <- 100019 # cambiar por su propia semilla  !!!
