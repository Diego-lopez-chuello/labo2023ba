...
PARAM <- list()
PARAM$experimento <- "ZZ6610_FINAL_04"
PARAM$exp_input <- "HT6510_FINAL_04"
...
PARAM$semillas <- c(100019, 100043, 100049, 100057, 100069, 420551, 589753, 632363, 770437, 810401)

PARAM$kaggle$envios_desde <- 9500L
PARAM$kaggle$envios_hasta <- 11500L
PARAM$kaggle$envios_salto <- 250L
