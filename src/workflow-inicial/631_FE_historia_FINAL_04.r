...
PARAM <- list()
PARAM$experimento <- "FE6310_FINAL_04"

PARAM$exp_input <- "DR6210_FINAL_04"
...
PARAM$RandomForest$semilla <- 100019 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 0.7
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 1.65
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 100043
