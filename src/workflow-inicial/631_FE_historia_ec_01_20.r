...
PARAM <- list()
PARAM$experimento <- "FE6310_EC_01_20"

PARAM$exp_input <- "DR6210_EC_01_20"
...
PARAM$RandomForest$semilla <- 420551 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 589753
